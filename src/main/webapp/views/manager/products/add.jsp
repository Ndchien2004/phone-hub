            ...
            <div class="card-body">
                ...
                <form action="${pageContext.request.contextPath}/manager/products" method="post"
                        ...
                        <div class="col-md-8">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" id="categoryId" name="categoryId" required>
                                        ...
                                        <c:forEach var="category" items="${categories}">
                                            <option value="${category.settingId}" ${param.categoryId==category.settingId
                                                ? 'selected' : '' }>
                                                ${category.name}
                                            </option>
                                        </c:forEach>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" id="memory" name="memory" required>
                                        ...
                                        <option value="64GB" ${param.memory=='64GB' ? 'selected' : '' }>64GB</option>
                                        <option value="128GB" ${param.memory=='128GB' ? 'selected' : '' }>128GB</option>
                                        <option value="256GB" ${param.memory=='256GB' ? 'selected' : '' }>256GB</option>
                                        <option value="512GB" ${param.memory=='512GB' ? 'selected' : '' }>512GB</option>
                                        <option value="1TB" ${param.memory=='1TB' ? 'selected' : '' }>1TB</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="quantity" name="quantity"
                                        value="${param.quantity}" min="0" required>
                                </div>
                                <div class="col-md-4 mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="briefInfo" name="briefInfo"
                                    value="${param.briefInfo}" maxlength="500">
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="${pageContext.request.contextPath}/manager/products" class="btn btn-secondary me-2">
                            Cancel
                        </a>
