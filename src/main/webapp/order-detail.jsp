    ...
    <div class="page-header">
        ...
        <div class="order-meta">
            ...
            <div class="meta-item">
                ...
                <span>Thanh toán: ${not empty order.paymentMethod.name ? order.paymentMethod.name : 'Chưa xác định'}</span>
            </div>
            <div class="meta-item">
                    ...
                    <c:when test="${not empty order.orderItems}">
                        <c:forEach var="item" items="${order.orderItems}">
                            <div class="product-item">
                                <img src="${not empty item.product.imageUrl ? item.product.imageUrl : 'https://via.placeholder.com/120x120?text=No+Image'}"
                                    ...
                                    <div class="product-pricing">
                                        ...
                                        <div class="quantity-total">
                                            ...
                                            <div class="total-price">
                                                <fmt:formatNumber value="${item.getTotalPrice()}" type="currency" currencySymbol="₫" maxFractionDigits="0" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="order-summary">
                ...
                <div class="summary-content">
                    ...
                    <c:forEach var="item" items="${order.orderItems}">
                        ...
                        <c:if test="${item.product.priceOrigin > item.product.priceSale}">
                            <c:set var="itemDiscount" value="${(item.product.priceOrigin - item.product.priceSale) * item.quantity}" />
                            <c:set var="totalDiscount" value="${totalDiscount + itemDiscount}" />
                        </c:if>
                    </c:forEach>
